...
var cache={};
function req(id){ if(cache[id]) return cache[id].exports; if(!modules[id]) throw new Error('Module not found: '+id); var module={exports:{}}; cache[id]=module; modules[id](req,module,module.exports); return module.exports; }
root.BPUCMSQRCode=req('index');
})(window);
