        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($valid) {
                ...
                if (!empty($context['redirect_to'])) {
                    ...
                    $normalized_requested = untrailingslashit($context['redirect_to']);

                    // Only pass through non-default explicit redirects.
                    if (!in_array($normalized_requested, $default_admin_urls, true)) {
                        $requested_redirect_to = $context['redirect_to'];
                    }
                }
