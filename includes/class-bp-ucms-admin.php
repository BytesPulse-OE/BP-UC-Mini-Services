...
final class BP_UCMS_Admin {
    ...
    public function save_settings(): void {
        ...
        foreach ($mode_fields as $field) {
            ...
            $settings[$field] = in_array($value, ['', 'same', 'page', 'admin'], true) ? $value : '';
        }
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="redirect_<?php echo esc_attr($role_key); ?>_mode">
                                        <option value="" <?php selected($saved_settings['redirect_' . $role_key . '_mode'], ''); ?>>— No redirect —</option>
                                        <option value="same" <?php selected($saved_settings['redirect_' . $role_key . '_mode'], 'same'); ?>>Stay on the same page</option>
                                        <option value="page" <?php selected($saved_settings['redirect_' . $role_key . '_mode'], 'page'); ?>>Redirect to a page</option>
                                        <option value="admin" <?php selected($saved_settings['redirect_' . $role_key . '_mode'], 'admin'); ?>>Redirect to wp-admin</option>
                                    </select>
                                    &nbsp;
